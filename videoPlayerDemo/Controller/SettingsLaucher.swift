...
//  videoPlayerDemo
//
//  Created by Welton Dornelas Magalhães on 09/01/2018.
...
enum SettingName: String {
    ...
    case SendFeedback = "Send Feddback"
    case Help = "Help"
...
class SettingsLaucher: NSObject, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    let settings: [Setting] = {
        let settingSettings = Setting(name: .Settings, imageName: "settings")
        let termsPrivacy = Setting(name: .TermsPrivacy, imageName: "privacy")
        let sendFeedback = Setting(name: .SendFeedback, imageName: "feedback")
